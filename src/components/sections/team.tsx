      ...
      <div className="container">
        ...
        <div className="mt-20">
          <div className="glass-card p-8 animate-fade-up">
            <h3 className="text-2xl font-semibold mb-6 text-gradient">Expertise Services</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                <h4 className="text-lg font-medium mb-2">Product Development</h4>
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                <h4 className="text-lg font-medium mb-2">App Development</h4>
                <p className="text-white/70 text-sm">
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                <h4 className="text-lg font-medium mb-2">Generative AI</h4>
                <p className="text-white/70 text-sm">
                  Experts in microbial ecosystems and food safety.
                </p>
              </div>
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                <h4 className="text-lg font-medium mb-2">AI & ML</h4>
                <p className="text-white/70 text-sm">
                  Specialists in spacecraft design and orbital mechanics.
                </p>
              </div>
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                <h4 className="text-lg font-medium mb-2">Project Development</h4>
                <p className="text-white/70 text-sm">
                  Specialists in plant growth and sustainability in extreme environments.
                </p>
              </div>
