...
export const ProblemSolution = () => {
  ...
  {/* The Problem Card */}
  <div className="relative p-8 overflow-hidden rounded-2xl border border-white/20 bg-white/10 backdrop-blur-md shadow-xl animate-fade-up">
    <h3 className="text-2xl font-semibold mb-6 relative z-10 text-white">The Problem</h3>
    <div className="space-y-6 relative z-10 text-white">
      
      <div className="flex items-start">
        <div className="w-10 h-10 rounded-full flex items-center justify-center bg-white/20 text-white mr-4 mt-1">1</div>
        <div>
      ...
      <div className="flex items-start">
        <div className="w-10 h-10 rounded-full flex items-center justify-center bg-white/20 text-white mr-4 mt-1">2</div>
        <div>
      ...
      <div className="flex items-start">
        <div className="w-10 h-10 rounded-full flex items-center justify-center bg-white/20 text-white mr-4 mt-1">3</div>
        <div>
  ...
  {/* Our Solution Card */}
  <div className="relative p-8 overflow-hidden rounded-2xl border border-white/20 bg-white/10 backdrop-blur-md shadow-xl animate-fade-up" style={{ animationDelay: '100ms' }}>
    <h3 className="text-2xl font-semibold mb-6 relative z-10 text-white">Our Solution</h3>
    <div className="space-y-6 relative z-10 text-white">
      ...
      <div className="flex items-start">
        <div className="w-10 h-10 rounded-full flex items-center justify-center bg-white/20 text-white mr-4 mt-1">4</div>
        <div>
