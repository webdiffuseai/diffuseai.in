            ...
            <div className="space-y-6">
              ...
              <div className="pt-6">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 rounded-full bg-stellar-blue/10 hover:bg-stellar-blue/20 flex items-center justify-center text-stellar-blue transition-colors">
